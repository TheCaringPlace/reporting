...
const BudgetTrackerPage = lazyRoute(
  () => import("./pages/BudgetTrackerPage.jsx"),
  fallback,
);
const FinancialsPage = lazyRoute(
  () => import("./pages/FinancialsPage.jsx"),
  fallback,
);
const ServiceReportPage = lazyRoute(
  () => import("./pages/ServiceReportPage.jsx"),
  fallback,
);
const ServiceExpensesPage = lazyRoute(
  () => import("./pages/ServiceExpensesPage.jsx"),
  fallback,
);
